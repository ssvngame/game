...
(function(){
    ...
    TEMPURA.tag["manpu"] = {
        ...
        start: function (pm) {
            ...
            if (typeof manpu.sound !== "undefined") {
                manpu.sound = sound_folder + manpu.sound;
            };
            // キャラ画像エレメントの取得
            ...
            if (typeof manpu.sound !== "undefined" && manpu.seplay === "true") {
                this.kag.ftag.startTag("playse", {
                    storage: manpu.sound,
                    volume: manpu.sevolume,
                    buf: manpu.sebuf,
                    stop: true
                });
            }
